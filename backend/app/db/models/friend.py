...
from sqlalchemy import String, TIMESTAMP, Enum, ForeignKey, func,Integer
...
class Friend(Base):
    ...
    receiver_id:  Mapped[int] = mapped_column(Integer, ForeignKey("user.user_id"), nullable=False)
    requester_id: Mapped[int] = mapped_column(Integer, ForeignKey("user.user_id"), nullable=False)
